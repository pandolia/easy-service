...
下载 [源码及程序v1.0.5](https://github.com/pandolia/easy-service/archive/v1.0.5.zip)，解压。右键单击 bin 目录下的 register-this-path.bat ，以管理员身份运行，将 bin 目录加入至系统路径中，也可以手动将此目录加入至系统路径。
